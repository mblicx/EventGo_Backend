...
SELECT place_id from place;
	...
	<div class="container">
		<h3
			class="text-center w3layouts w3 w3l w3ls agileits agileinfo wthree w3-agileits">Insert
			user</h3>
		<form action="AddUserServlet" method="post"
			onsubmit="return validataForm();">
			<table border="1" bordercolor="#EB5425" align=center>
				...
				<tr>
					...
					<td><input type="text" name="user_name" id="user_name"
						...
						data-validation-required-message="Please enter your event name."
						style='font-size: 18px' width=200 /></td>
				</tr>
				<tr>
					<td>User_code:</td>
					<td><input type="password" name="user_code" id="user_code"
						class="form-control" required
				...
				<tr>
					<td>User_type:</td>
					<td><select name="user_type" style='font-size: 14px' width=200
						class="form-control">
				...
				<tr>
					<td>Manager_id:</td>
					<td><input type="text" name="manager_id" class="form-control"
		...
		<button type="submit" class="btn btn-primary">
			<a href="ManageEvents.jsp?uid=<%=uid%>">RETURN</a>
		</button>
	</div>
	</section>
	<!-- footer section -->
