...
<section class="contact-w3ls">
	<div class="container">
		<h3 class="text-center w3layouts w3 w3l w3ls agileits agileinfo wthree w3-agileits">Update user</h3>
<form action="UpdateUserServlet" method="post" onsubmit="return validataForm();">	
				<table border="2" bordercolor="#EB5425" align=center> 
	
					<tr>
						<td>User_id:</td><td><input type="text" name="user_id" class="form-control"
							value="<%=nuid %>" style='font-size:18px' width=200 readonly"/></td>
					</tr>
					<tr>
						<td>User_name:</td><td><input type="text" name="user_name" id="user_name" class="form-control" required data-validation-required-message="Please enter your user name."
							style='font-size:18px' width=200/></td>
					</tr>
					<tr>
						<td>User_code:</td><td><input type="password" name="user_code" id="user_code" class="form-control" required data-validation-required-message="Please enter password."
							style='font-size:18px' width=200/></td>
					</tr>
					<tr>
						<td>Repeat User_code:</td><td><input type="password" name="repassword" id="repassword" class="form-control" required data-validation-required-message="Please enter password."
							style='font-size:18px' width=200/></td>
					</tr>
					<tr>
						<td>User_type:</td><td><select name="user_type" style='font-size:14px' width=200 class="form-control">
						<option value="customer">customer</option>
						<option value="manager">manager</option>						
					</select>
					</tr>
					<tr>
						<td>Manager_id:</td><td><input type="text" name="manager_id" step="10" class="form-control"
  ...
  <script type="text/javascript">  
    ...
    function validataForm(){  
        ...
        var password = document.getElementById("user_code").value;  
        if(password == ""){  
