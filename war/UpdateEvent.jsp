...
<form action="UpdateServlet" method="post">	
				<table border="2" bordercolor="#EB5425" align=center> 
					<tr>
						<td>Event_id:</td><td><input type="text" name="event_id" class="form-control"
					...
					<tr> 
					<td>Place_id:</td><td><select name="place_id" style='font-size:18px' width=200 class="form-control">
					<c:forEach var="row" items="${result.rows}" > 
						<option><c:out value="${row.place_id}"/></option>						
                	</c:forEach>
					</select>
	  				</td>  
					</tr>
					...
					<tr>
						<td>State:</td><td><input type="text" name="state" value="0" class="form-control" required data-validation-required-message="Please enter state."
							style='font-size:18px' width=200/></td>
					</tr>
					<tr>
