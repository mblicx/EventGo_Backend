...
<section class="contact-w3ls">
	<div class="container">
		<h3 class="text-center w3layouts w3 w3l w3ls agileits agileinfo wthree w3-agileits">Insert Place</h3>
<form action="AddPlaceServlet" method="post" name="sentMessage" id="contactForm" novalidate>	
				<table border="1" bordercolor="#EB5425" align=center> 
					<tr>
						<td>Manager_id:</td><td><input type="text" name="manager_id" class="form-control"
							value="<%=uid %>" style='font-size:18px' width=200 readonly/></td>
					</tr>
					<tr>
						<td>Place_id:</td><td><input type="text" name="place_id" class="form-control" required data-validation-required-message="Please enter your event name."
							style='font-size:18px' width=200/></td>
					</tr>
					<tr>
						<td>coordinates_y:</td><td><input type="text" name="coordinates_y" class="form-control" required data-validation-required-message="Please enter coordinates_y."
							style='font-size:18px' width=200/></td>
					</tr>
					<tr>
						<td>coordinates_x:</td><td><input type="text" name="coordinates_x" class="form-control" required data-validation-required-message="Please enter coordinates_x."
							style='font-size:18px' width=200/></td>
					</tr>
					<tr>
						<td>Postcode:</td><td><input type="text" name="postcode" class="form-control" required data-validation-required-message="Please enter description."
							style='font-size:18px'/></td>
					</tr>
					<tr>
						<td>Address:</td><td><input type="text" name="address" class="form-control" required data-validation-required-message="Please enter charge."
							style='font-size:18px'/></td>
					</tr>
