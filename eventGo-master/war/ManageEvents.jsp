				  ...
				  <div class="container">
					  ...
					  <div id="navbar" class="navbar-collapse collapse">
						<ul class="nav navbar-nav">
							<li class="active"><a href="index.jsp?uid=<%=uid%>">Home</a></li>
							<li><a href="about.jsp?uid=<%=uid%>">About</a></li>
							<li><a href="contact.jsp?uid=<%=uid%>">Contact</a></li>
							<%
							String url="";
...
<table  border="2" bordercolor="#EB5425" align=center> 
		    ...
		    <button class="btn btn-primary"><a href="InsertEvent.jsp?uid=<%=uid%>">ADD</a></button>  
             </div> 
            </section>  
  </section>
  <!-- footer section -->
