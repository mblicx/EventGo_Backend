...
<section class="contact-w3ls">
	<div class="container">
		<h3 class="text-center w3layouts w3 w3l w3ls agileits agileinfo wthree w3-agileits">Update events</h3>
<form action="UpdateServlet" method="post">	
				<table border="2" bordercolor="#EB5425" align=center> 
					<tr>
						<td>Event_id:</td><td><input type="text" name="event_id" 
							value="<%=id %>" style='font-size:18px' width=200 readonly"/></td>
					</tr>
					<tr>
						<td>Event_name:</td><td><input type="text" name="event_name" 
							style='font-size:18px' width=200/></td>
					</tr>
					<tr>
						<td>Place_id:</td><td><select name="place_id" style='font-size:18px' width=200>
					...
					<tr>
						<td>Start_date:</td><td><input type="date" name="start_date" 
							style='font-size:18px' width=200/></td>
					</tr>
					<tr>
						<td>End_date</td><td><input type="date" name="end_date" 
							style='font-size:18px'/></td>
					</tr>
					<tr>
						<td>Start_time:</td><td><input type="time" name="start_time" step="10"
							style='font-size:18px' width=200/></td>
					</tr>
					<tr>
						<td>End_time</td><td><input type="time" name="end_time" step="10"
							style='font-size:18px'/></td>
					</tr>
					<tr>
						<td>State:</td><td><input type="text" name="state" value="0"
							style='font-size:18px' width=200/></td>
					</tr>
					<tr>
						<td>Type_id:</td><td><input type="text" name="type_id" 
							style='font-size:18px' width=200/></td>
					</tr>
					<tr>
						<td>Description:</td><td><input type="text" name="description" 
							style='font-size:18px'/></td>
					</tr>
					<tr>
						<td>Charge:</td><td><input type="text" id="charge" name="charge" 
							style='font-size:18px'/></td>
					</tr>
					<tr>
						<td>Image:</td><td><input type="file" name="image" accept="image/*"
							style='font-size:18px'/></td>
					</tr>
					<tr>
						<td>User_id:</td><td><input type="text" name="user_id" 
